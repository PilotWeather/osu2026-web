...
export default async function OperationsPage({ searchParams }: OperationsPageProps) {
  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-6 dark:bg-[#0b0f19] sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl space-y-6"><AppHeader title="Operasyon Dashboard" subtitle="Tamamlanmış uçuşların günlük görünümü" showNaeronSync />
